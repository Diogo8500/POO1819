...
public class Triangle {
     ...
     */
    public Vector2D getNoneEdgeVertex(Segment edge) {
     ...
     */
    public SegmentDistance findNearestEdge(Vector2D point) {
     ...
     */
    private Vector2D computeClosestPoint(Segment edge, Vector2D point) {
