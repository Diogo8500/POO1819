...
public class DelaunayTriangulator {
    ...
    public void triangulate() throws NotEnoughPointsException {
        ...
        for (int i = 0; i < pointSet.size(); i++) {
            ...
            if (triangle == null) {
                ...
                legalizeEdge(triangle1, new Segment(edge.a, firstNoneEdgeVertex), pointSet.get(i));
                legalizeEdge(triangle2, new Segment(edge.b, firstNoneEdgeVertex), pointSet.get(i));
                legalizeEdge(triangle3, new Segment(edge.a, secondNoneEdgeVertex), pointSet.get(i));
                legalizeEdge(triangle4, new Segment(edge.b, secondNoneEdgeVertex), pointSet.get(i));
            } else {
                /**
     ...
     *            The new vertex
     */
    private void legalizeEdge(Triangle triangle, Segment edge, Vector2D newVertex) {
        ...
        if (neighbourTriangle != null) {
            if (neighbourTriangle.isPointInCircumcircle(newVertex)) {
                ...
                legalizeEdge(firstTriangle, new Segment(noneEdgeVertex, edge.a), newVertex);
                legalizeEdge(secondTriangle, new Segment(noneEdgeVertex, edge.b), newVertex);
            }
        }
    }
